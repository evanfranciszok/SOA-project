...
public class JmsConfiguration {
    ...
    @Autowired
    public JmsConfiguration(@Qualifier("webApplicationContext") ResourceLoader resourceLoader) {
    ...
    public MessageConverter jaxbMarshaller() {
        ...
        jaxb2Marshaller.setPackagesToScan("com.example.mealplanningservice.integration");
//        jaxb2Marshaller.setSchemas(
//                resourceLoader.getResource("classpath:xsd/Recipe.xsd"),
//                resourceLoader.getResource("classpath:xsd/RecipesRequest.xsd")
//        );
